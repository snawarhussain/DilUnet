...
class UnetVariant_1(nn.Module, ABC):
    ...
    def forward(self, X):
        ...
        MultiOutput1 = nn.functional.interpolate(self.MultiOutput1(X6Block), 292)
        MultiOutput2 = nn.functional.interpolate(self.MultiOutput2(X7Block), 292)
        MultiOutput3 = nn.functional.interpolate(self.MultiOutput3(X8Block), 292)
