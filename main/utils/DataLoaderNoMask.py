...
class CustomDataLoaderNoMask(Dataset):
    ...
    def __init__(self, img_dir, label_dir, transform, transform_label, image_scale = None):
    ...
    @classmethod
    def preprocessing(cls, image, label, size=None, scale=None):
    ...
    def __getitem__(self, idx):
       ...
       # mask_loc = os.path.join(self.mask_dir, self.total_masks[idx])
        ...
        label = Image.open(label_loc) .convert('L') # opening image and converting it to the grey scale
...
if __name__ == '__main__':
    img_dir = 'CHASEDB1/train/img/'
    label_dir = 'CHASEDB1/train/1st_manual/'
    ...
    dataset = CustomDataLoaderNoMask(img_dir, label_dir, transform, transform_label,)
